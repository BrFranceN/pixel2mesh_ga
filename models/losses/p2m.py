...
from models.layers.chamfer_wrapper import ChamferDist
from models.losses.multivectorloss import MVLoss
from pgaloss import PGALoss
...
class P2MLoss(nn.Module):
    def __init__(self, options, ellipsoid):
        ...
        #new loss
        self.geometric_algebra_loss = PGALoss()
        ...
        # self.mv_loss = MVLoss([1,1,1]) # loss type (01)
    ...
    def multivector_regularization(self,outputs,targets):
        return self.mv_loss(outputs,targets)
    ...
    def forward(self, outputs, targets):
        ...
        for i in range(3):
            ...
            # mv_regular+= self.multivector_regularization(pred_coord[i],gt_coord) #new 01

            mv_regular+= self.geometric_algebra_loss(pred_coord[i],gt_coord) #new 01
        ...
        loss = chamfer_loss + image_loss * self.options.weights.reconst + \
               ...
               self.options.weights.edge * edge_loss + \
               self.options.weights.normal * normal_loss + \
               self.options.weights.mvloss * mv_regular
        ...
        # return loss,{"loss_mv":mv_regular}
