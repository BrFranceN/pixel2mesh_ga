...
sys.path.append(os.path.join(BASE_DIR, '../../clifford-group-equivariant-neural-networks'))
...
class ChamferDistance(torch.nn.Module):
    ...
    def forward(
        ...
        mv_target_matrix = self.ca.geometric_product(mv_target.unsqueeze(1), mv_target.unsqueeze(2))
        mv_output_matrix = self.ca.geometric_product(mv_output.unsqueeze(1), mv_output.unsqueeze(2))
